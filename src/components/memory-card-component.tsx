...
export const MemoryCard = ({
  ...
  return (
    <div
      className={`aspect-square w-20 sm:w-28 md:w-32 lg:w-36 ${isMatched ? "cursor-not-allowed" : "cursor-pointer"}`}
      ...
      >
        ...
        >
          <img
            src={icon}
            alt="Memory Card"
            className={`w-18 h-18 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 ${isMatched ? "opacity-60" : ""}`}
          />
        </motion.div>
      </motion.div>
    </div>
