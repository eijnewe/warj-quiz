  ...
  return (
    <main className="flex justify-center">
      <div className="flex flex-col justify-center items-center m-2 *:m-2 w-[70vw] max-w-[80vw]">
        <h2 className="font-bold uppercase mb-4 text-3xl text-center">Resultat-historik</h2>
        <Accordion.Root type="multiple" className="*:m-2 *:rounded-sm w-full">
          <Accordion.Item value="item-1" className="bg-card cursor-pointer p-2 flex flex-col">
          ...
          <Accordion.Item value="item-2" className="bg-card cursor-pointer p-2 flex flex-col">
            <Accordion.Trigger className="flex justify-center pb-2 cursor-pointer">
              Memory-resultat
              <ArrowDown />
            </Accordion.Trigger>
            <Accordion.Content>
              <div className="p-4">Add memory results here plsss</div>
            </Accordion.Content>
          </Accordion.Item>
        </Accordion.Root>
        <Link to="/">
