...
type WolfType = "wolf1" | "wolf2" | "wolf3" | "wolf4" | "wolf5" | "wolf6" | "wolf7" | "wolf8" | "wolf9" | "wolf10";
...
function getResult(answers: Answer[]): WolfType {
  ...
  const sorted = (Object.entries(counts) as [Answer, number][]).sort((a, b) => b[1] - a[1]);
  ...
  return (
    <main>
      <div className="flex flex-col justify-center items-center m-2 *:m-2">
        ...
        {showResult && result && <WolfComponent id={result} />}
      </div>
    </main>
  );
}
